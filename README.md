...
- [x] The crypto between client and send proxy FIX Needed
...
- [x] The cryptography stuff: Public keys and MAC from the sending proxy to the recv proxy, for now, leave unimplemented (actually CMAC has been handled now)
- [x] Initialization of MAC pair between proxies needed, plus the usual key initialization 
